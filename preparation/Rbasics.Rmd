...
```{r assigning values to variables}
...
## Add more people to your data frame
Add "Salma" (weight=61, height=166, is_fit=TRUE, affiliation=QSTP ) and
Add "Khaled" (weight=75, height=175, is_fit=FALSE, affiliation=QSTP ) 

to the data frame 
Hint: you can use *c()* to grow each of your vectors. E.g. `weights<-c(weights,61,75)` 
